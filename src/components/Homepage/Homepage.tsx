      ...
      <div className="banner-section">
              ...
              zIndex: '0'
                  ...
                  <Box sx={{ 
                      ...
                      <Box sx={{width:'58%'}}>
                          <Typography
                              variant="h2" sx={{ mb: '1.5rem', fontSize: '4.1rem', color: '#fff' }}
                          >Trust and Security</Typography>
                          <Typography 
                              component="div" 
            ...
            <span className="arrow-image"></span>
              ...
              <div className="banner-div">
                  <img className="banner-img" src="/images/banners/home-banner.jpg" alt="Banner Image"/>
              </div>
