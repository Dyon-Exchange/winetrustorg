export const wtProblemsConst = [
  {
    id: 'ownership-tile',
    icon: '/images/general/ownership.svg',
    desc: 'WineTrust guarantees ownership independent of any merchant'
  },
  {
    id: 'audit-tile',
    icon: '/images/general/audit.svg',
  ...
  {
    id: 'marketplace-tile',
    icon: '/images/general/marketplace.svg',
