  ...
  return (
    <div className={classes.root}>
      ...
      <Container className="container">
        <h2>Privacy Policy for WineTrust</h2>

        <p>
          At WineTrust, accessible from{' '}
          ...
          contains types of information that is collected and recorded by WineTrust and how we use
          it.
        </p>
        ...
        <p>
          ...
          website with regards to the information that they shared and/or collect in WineTrust. This
        ...
        <p>
          WineTrust follows a standard procedure of using log files. These files log visitors when
        ...
        <p>
          Like any other website, WineTrust uses ‘cookies’. These cookies are used to store
        ...
        <p>
          ...
          WineTrust, which are sent directly to users’ browser. They automatically receive your IP
        ...
        <p>
          Note that WineTrust has no access to or control over these cookies that are used by
        ...
        <p>
          WineTrust’s Privacy Policy does not apply to other advertisers or websites. Thus, we are
        ...
        <p>
          WineTrust does not knowingly collect any Personal Identifiable Information from children
