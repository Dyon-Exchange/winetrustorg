...
const bannerConst = {
  ...
  image: '/images/security/features/storage/storage-bg-3.png',
  description: ''
}

const policyStyles = makeStyles({
  root: {
    '& h2': {
  ...
  return (
    <div className={classes.root}>
      ...
      <Container className="container">
        <h2>Privacy Policy for Wine Trust</h2>

        <p>
          At Wine Trust, accessible from www.winetrust.com, one of our main priorities is the
          privacy of our visitors. This Privacy Policy document contains types of information that
          is collected and recorded by Wine Trust and how we use it.
        </p>
        ...
        <p>
          ...
          website with regards to the information that they shared and/or collect in Wine Trust.
        ...
        <p>
          Wine Trust follows a standard procedure of using log files. These files log visitors when
        ...
        <p>
          Like any other website, Wine Trust uses ‘cookies’. These cookies are used to store
        ...
        <p>
          ...
          Beacons that are used in their respective advertisements and links that appear on Wine
          Trust, which are sent directly to users’ browser. They automatically receive your IP
        ...
        <p>
          Note that Wine Trust has no access to or control over these cookies that are used by
        ...
        <p>
          Wine Trust’s Privacy Policy does not apply to other advertisers or websites. Thus, we are
        ...
        <p>
          Wine Trust does not knowingly collect any Personal Identifiable Information from children
